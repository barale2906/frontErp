...
export default function TecnicaCargaProd(){
    ...
    const tipo = window.sessionStorage.getItem("tipo")
    ...
    const onSubmit = async (cargaInfo) => {
        ...
        if(tipo==="2"){
            var data={
                bodegaId:cargaInfo.bodegaId,
                cantidad:cargaInfo.cantidad,
                costo:cargaInfo.costo,
                encabId:cargaInfo.encabId,
                observations:cargaInfo.observations,
                prodId:cargaInfo.prodId
            };
        }else if(tipo==="1"){
            var data=cargaInfo;
        }
                ...
                <div className="modal-body">
                    <div className="row">
                        ...
                        </div>
                        {
                            tipo==="2" ? 
                                <>
                                <button type="submit" className="btn btn-info">Insertar</button>
                                </>
                                :
                                <>
                                    <div className="col-sm-4 ">
